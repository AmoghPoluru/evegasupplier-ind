...
import { Building2, Mail, Calendar, Package, MapPin, Phone } from 'lucide-react';
...
export function OrderDetailModal({
  ...
  const { data: order, isLoading } = trpc.buyers.orders.getOne.useQuery(
    { orderId },
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">
                    {typeof order.supplier === 'object' && order.supplier
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {typeof order.supplier === 'object' && order.supplier && 
                     typeof (order.supplier as any).user === 'object' && (order.supplier as any).user?.email
                      ? (order.supplier as any).user.email
                      : 'No email'}
                  </p>
                </div>
              </div>
